...
// ----------------- Network Tree (KODE LAMA DIGANTI DENGAN INI) -----------------
// Kode ini HANYA akan menargetkan <svg id="networkGraph"> untuk zoom/pan
function renderNetwork() {
  ...
  // ==== FIX: Zoom & Pan HANYA PADA KARTU INI ====
  const svgNode = svg.node();
  svgNode.style.touchAction = "none"; // Ini SANGAT PENTING di HP

  const panzoom = Panzoom(svgNode, { // Panzoom ditargetkan HANYA ke svgNode
    contain: 'outside',
    maxScale: 3,
    minScale: 0.3,
    step: 0.2,
  ...
  // Listener event HANYA ditambahkan ke svgNode (grafik), bukan ke seluruh halaman
